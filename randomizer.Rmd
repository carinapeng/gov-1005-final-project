...
saveRDS(object = river, file = "shiny_app/river.RDS")
saveRDS(object = quad, file = "shiny_app/quad.RDS")
saveRDS(object = river_central, file = "shiny_app/river_central.RDS")
saveRDS(object = river_east, file = "shiny_app/river_east.RDS")
saveRDS(object = river_west, file = "shiny_app/river_west.RDS")
