...
multiple_houses <- sheet %>% 
  rep_sample_n(size = nrow(sheet), replace = FALSE, reps = 3) %>% 
  group_by(replicate) %>% 
  
  # break here and assign houses to every single person using map.
  # then assign community using map
