...
overview <- function(assigned, community){
  ...
  tibble(
    ...
    prop_ethnicity = as.tibble(ethnicity(community)) %>% nest(data = everything()),
    prop_religion = as.tibble(religion(community)) %>% nest(data = everything()),
    prop_sexual_orientation = as.tibble(sexual_orientation(community)) %>% nest(data = everything()),
    distr_group_size = as.tibble(group_size(community)) %>% nest(data = everything()),
    prop_suitemates_reasons = as.tibble(suitemates_reasons(community)) %>% nest(data = everything()),
  )
