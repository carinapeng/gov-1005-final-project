...
overview <- function(assigned, community){
  ...
  tibble(
    ethnicity = tibble(
      prop_white = count(filter(community$ethnicity == 1))/nrow(community),
      prop_asian = count(filter(community$ethnicity == 2))/nrow(community),
      prop_black = count(filter(community$ethnicity == 3))/nrow(community),
      prop_hisp = count(filter(community$ethnicity == 4))/nrow(community),
      prop_mideast = count(filter(community$ethnicity == 5))/nrow(community),
      prop_natam = count(filter(community$ethnicity == 6))/nrow(community),
      prop_prefnot = count(filter(community$ethnicity == 7))/nrow(community),
      prop_other = count(filter(community$ethnicity == 8))/nrow(community)
    ),
    
    religion = tibble(
      prop_agnostic = count(filter(community$religion == 1))/nrow(community),
      prop_christian = count(filter(community$religion == 2))/nrow(community),
      prop_atheist = count(filter(community$religion == 3))/nrow(community),
      prop_jewish = count(filter(community$religion == 4))/nrow(community),
      prop_hind = count(filter(community$religion == 5))/nrow(community),
      prop_muslim = count(filter(community$religion == 6))/nrow(community),
      prop_prefnot = count(filter(community$religion == 7))/nrow(community),
      prop_other = count(filter(community$religion == 8))/nrow(community)
    ),
    
    sexual_orientation = tibble(
      prop_hetero = count(filter(community$sexual_orientation == 1))/nrow(community),
      prop_homo = count(filter(community$sexual_orientation == 2))/nrow(community),
      prop_bi = count(filter(community$sexual_orientation == 3))/nrow(community),
      prop_as = count(filter(community$sexual_orientation == 4))/nrow(community),
      prop_prefnot = count(filter(community$sexual_orientation == 5))/nrow(community),
      prop_other = count(filter(community$sexual_orientation == 6))/nrow(community)
    ),
    
    suitemates = tibble(
      prop_yes = count(filter(community$suitemates == 1))/nrow(community),
      prop_no = count(filter(community$suitemates == 0))/nrow(community)
    ),
    
    group_size = tibble(
      prop_1 = count(filter(community$group_size == 1))/nrow(community),
      prop_2 = count(filter(community$group_size == 2))/nrow(community),
      prop_3 = count(filter(community$group_size == 3))/nrow(community),
      prop_4 = count(filter(community$group_size == 4))/nrow(community),
      prop_5 = count(filter(community$group_size == 5))/nrow(community),
      prop_6 = count(filter(community$group_size == 6))/nrow(community),
      prop_7 = count(filter(community$group_size == 7))/nrow(community),
      prop_8 = count(filter(community$group_size == 8))/nrow(community)
    ),
...
all_communities <- sheet %>% 
  ...
  rep_sample_n(size = nrow(sheet), replace = FALSE, reps = 5) %>% 
  group_by(replicate)  %>% 
  nest() %>% 
